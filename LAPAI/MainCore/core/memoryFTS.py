from .state import *
def compact_old_memory(client,model,session_id,minutes=5,max_summary_tokens=500):
    ...
    if summarized_until_rowid > 0:
        ...
        # Backward-compatible path for sessions created before the rowid
        # checkpoint existed.
...
def summarize_session(client,model,session_id,max_tokens=500):
